...
树莓派AI实验
目标检测
基于ssd_mobilenet_v2量化模型的Tensorflow Lite模型实现视频数字九宫格识别
'''
import argparse
import cv2
import numpy as np
...
parser.add_argument('--modeldir', default='../TFLite_model/Model_Sudoku_1')
# .tflite文件名
...
# 视频路径
parser.add_argument('--video', default='Test_videos/Sudoku.mov')
